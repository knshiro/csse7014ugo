...
public class HomeManagerRPCClientStub implements NotificationListener{
	...
	public HomeManagerRPCClientStub(String server, String applicationId, String id){
	...
	public String getProgrammeDescription(String name){
		...
		processCall("ProgDesc","EPG1SERVER", args);
		returnValue = new String((String)this.result);
		return returnValue;
		
	}
	
	public Object getProgrammeForPeriod(String day, int start, int end){
		String returnValue;
		ArrayList<Object> args = new ArrayList<Object>();
